;------------------------------------------------------
;- porta-sal.asm  (c) Juan Gonzalez. Febrero 2004
;------------------------------------------------------
; Enviar un valor por el puerto A de la tarjeta GPBOT
;------------------------------------------------------
; Licencia GPL
;------------------------------------------------------
...
main:
	lda	#0xFF	; Configurar puerto A para salida
	sta	DDRA

	lda	#0x55	; Enviar un valor al puerto A
	sta	PORTA
